...
def load_embedding_weights(vocabulary, embedding_size, embedding_type, data_path="."):
    ...
    :rtype: numpy.array
    """
    if os.path.exists(f'{data_path}/embedding_matrix_{embedding_type}_{embedding_size}.pkl'):
        with open(f'{data_path}/embedding_matrix_{embedding_type}_{embedding_size}.pkl', 'rb') as f:
        ...
        with open(f'{data_path}/embedding_matrix_{embedding_type}_{embedding_size}.pkl', 'wb') as f:
